    ...
    <div className='my-64'>
        ...
        <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
            ...
            <ul className='w-full flec flex flex-col itmes-start justify-between ml-4 xs:ml-2'>
                <Details 
                position="Research Intern" company="National Institute of Technology, Kurukshetra"
                time="March 2023"  address="Kurukshetra" companyLink="https://nitkkr.ac.in"
                work="Developed a highly accurate system with an accuracy of 99.8% for detecting potato diseases using VGG16 and VGG19 convolutional NN architectures.
