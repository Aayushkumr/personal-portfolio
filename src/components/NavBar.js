...
import { GithubIcon, LinkedInIcon, PinterestIcon, MediumIcon, SunIcon, MoonIcon } from "./icons"
        ...
        >
            ...
            <div className="w-full flex justify-between items-center lg:hidden ">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://github.com/Aayushkumr" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mr-3"
                    >
                    ...
                    <motion.a href="https://www.linkedin.com/in/aayush-kumr/" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >
                    ...
                    <motion.a href="https://in.pinterest.com/aayushkumr25" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    ...
                    <motion.a href="https://medium.com/@aayushkumr25" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >
